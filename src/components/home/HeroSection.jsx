...
export default function HeroSection() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:space-x-8 min-h-screen">

    <section className="w-full md:w-1/2  mx-12 my-12 text-center md:text-left">
        <div className="max-w-2xl mx-auto">
            ...
            <a href="/store" className="mt-6 inline-block bg-gray-200 text-pink-500 px-6 py-3 rounded-lg text-lg shadow-md hover:bg-gray-600 transition">Shop Now</a>
        </div>
    </section>
